...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?39ab0c5" media="screen"/>
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?php echo ROOT_PATH ?>favicon.png" sizes="64x64" />
